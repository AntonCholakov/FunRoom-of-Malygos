...
- А, не ща!!! Говоряща жаба по-ме кефи – отговорил програмистът.</pre>
					...
					<article>
						<pre>На Иванчо са му дали 3 ябълки.
Той е изял 2.
...
Извод – четете си спецификацията.</pre>
					</article>
					

					<article>
						<pre>Жена на програмист го праща до магазина:
...
- Как защо?! – имаше яйца…</pre>
					</article>
    
                    <article><pre>Диалог между програмист и жена му, вечер след работа..
Прибира се той:
...
- Unknоwn Virus!</pre></article>

                    <article><pre>Програмист се прибира в пет часа сутринта. 
Жена му изнервена го очаква на вратата: 
- Миришеш ми на чужди компютри…</pre></article>

<article><pre>Kакво е общото между индиански вигвам и Linux?
No Gates, no Windows, Apache inside.</pre></article>

                    <article><pre>Младеж, завършил институт и постъпил на работа във фирма. 
На втория ден началникът го извикал и попитал: 
- Ти силен програмист ли си? 
- Как да ви кажа? 
- Е силен ли си? 
- В общи линии, да. 
- Тогава ще се заемеш с преместването на компютрите.</pre></article>

                    <article><pre>Истинският програмист не може да умре от глад,
дори хладилника да е празен. 
Той винаги може да изкара поне още една седмицa 
с хранителните запаси натрупали се в клавиатурата.</pre></article>

                    <article><pre>Програмист се налива цяла нощ с ракия. 
...
– Мммдааааааа. Интересен бъг…</pre></article>

<article><pre>Момченце в зоопарка с майка си, майката обяснява:
...
- Защо реши така сине?
- Ами те са като татко - рошави и имат мазол на задника...</pre></article>

                    <article><pre>Говорят си двама програмисти: 
